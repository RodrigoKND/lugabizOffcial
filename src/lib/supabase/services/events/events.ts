...
export const eventsService = {
  ...
  async updateEvent(id: string, updates: Partial<CreateEventData>): Promise<Event> {
    const fieldMap: Record<string, string> = {
      ...
      categoryId: 'category_id', image: 'image', dateStart: 'date_start',
      timeStart: 'time_start', timeEnd: 'time_end', price: 'price',
      capacity: 'capacity', isFree: 'is_free', tags: 'tags', coords: 'coords',
    };
