...
import SocialGroupSelector from '@/presentation/components/features/SocialGroupSelector';
import AmenitySelector from '@/presentation/components/features/AmenitySelector';
import CollapsibleSection from '@/presentation/components/features/CollapsibleSection';
import DiscountSection from '@/presentation/components/features/DiscountSection';
...
const AddPlace: React.FC = () => {
  ...
  const handleDiscountChange = (discountInfo: PlaceFormData['discountInfo']) => {
...
const PlaceNameInput: React.FC<{ formData: PlaceFormData; onInputChange: any }> = ({ formData, onInputChange }) => (
...
const CategorySelect: React.FC<{ formData: PlaceFormData; categories: any[]; onInputChange: any }> = ({ formData, categories, onInputChange }) => (
...
const DescriptionInput: React.FC<{ formData: PlaceFormData; onInputChange: any }> = ({ formData, onInputChange }) => (
  <div className="space-y-2">
...
const SocialGroupsSection: React.FC<{ formData: PlaceFormData; socialGroups: any[]; onChange: any }> = ({ formData, socialGroups, onChange }) => (
...
interface OptionalSectionsProps {
  ...
  onDiscountChange: (discountInfo: PlaceFormData['discountInfo']) => void;
}
