...
const EventDetailPage: React.FC = () => {
  ...
  return (
    <section className="min-h-screen bg-[#FDFDFD] text-slate-900 selection:bg-rose-100">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-xl border-b border-slate-100 px-6 py-4 flex justify-between items-center">
        <Link 
          to="/"
            ...
            <div className="sticky top-28 space-y-8">
              <div className="bg-white rounded-[3rem] border border-slate-100 p-10 shadow-2xl shadow-slate-200/60 relative overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <button className="group w-full bg-primary-600 hover:bg-primary-700 text-white py-2 rounded-4xl font-black text-lg transition-all active:scale-[0.97] flex items-center justify-center gap-3 shadow-xl shadow-slate-200">
              ...
              <div className="flex items-center justify-between px-8 py-6 bg-slate-50/50 rounded-4xl border border-slate-100/50">
