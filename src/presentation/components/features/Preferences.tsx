        ...
        <form onSubmit={handleSubmitPreferences} method="POST">
          <header className="sticky top-0 px-8 pt-4 lg:pt-6 mb-6 z-50 bg-white/90 backdrop-blur-sm ">
            <div className="flex justify-between items-center">
              <h2 className="font-bold flex gap-x-1 items-center mb-2 text-purple-800">
                <span><img src='/L.ico' alt='Lugabiz' className='w-6 h-auto' /></span>
                <span className='text-2xl text-purple-800'>Lugabiz</span>
              </h2>
              <button className="hover:bg-purple-100 rounded-full p-2" type='button' aria-label="cerrar preferencias" onClick={onClose}>
                <X className="w-6 h-6" />
              </button>
            </div>
          ...
          <section className="mb-6 px-8 text-center">
            <header className="mb-2">
              <h4 className="font-bold text-2xl mb-2">Elige lo que más te guste</h4>
              <p className="text-gray-800 text-md">Lugabiz se actualizará en función a tu selección</p>
            </header>
          </section>
          ...
          <section className="mb-8 px-8">
            <header className="mb-4">
              ...
              <p className="text-gray-800 text-md">Elige tus intereses (puedes cambiarlos luego en tu perfil).</p>
            </header>
            <SocialGroupSelector
          ...
          <section className="mb-8 px-8">
            <header className="mb-4">
              ...
              <p className="text-gray-800 text-md">Selecciona tus categorías favoritas</p>
            </header>
            <SocialGroupSelector
          ...
          <footer className="flex justify-center px-8 mb-8">
            <button className="w-full text-white bg-purple-600 rounded-md px-4 py-2 hover:bg-purple-600/90 text-md font-semibold" type="submit">
