        ...
        <div className="relative w-full h-full md:rounded-3xl overflow-hidden md:shadow-2xl">
          ...
          <div className="relative h-full flex flex-col justify-between p-5 md:p-6">
            <div className="flex items-start justify-between mt-8 md:mt-0">
              ...
              <button className="text-white/90 hover:text-white"><MoreHorizontal className="w-5 h-5" /></button>
            </div>
                ...
                <div className="relative">
                  ...
                  <div className="flex gap-2 mt-1">
                    {!isExpanded && event.description.length > 100 && (
                      <button onClick={() => setIsExpanded(true)} className="text-primary-400 text-xs font-bold hover:underline">ver más</button>
                    )}
              ...
              <div className="p-4 border-t bg-white safe-bottom">
                <div className="flex items-center gap-2">
                  ...
                  <button disabled={!comment.trim()}
                    className={`p-2 rounded-full transition-all ${comment.trim() ? 'bg-gradient-to-r from-primary-500 to-tomato text-white' : 'bg-gray-200 text-gray-400'}`}>
