...
import { X, ShieldCheck, Camera, CreditCard, FileCheck2, Loader2, Clock, CheckCircle2, ChevronRight, ChevronLeft, Lock, Sparkles, RotateCcw, BadgeCheck } from 'lucide-react';
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <input type="text" value={fullName} onChange={e => setFullName(e.target.value)}
                      placeholder="Ej: Molly Benítez Murphy "
                      className="w-full px-4 py-2.5 bg-primary-50/50 border border-primary-100 rounded-xl text-sm outline-none focus:border-primary-300 focus:bg-white transition-all" />
                  </div>
                  ...
                  <div className="flex gap-2 pt-1">
                    ...
                    <button onClick={runPrecheck} disabled={!selfie || !ciFront || !ciBack || !fullName.trim()}
                      ...
                      <Sparkles className="w-4 h-4" /> Analizar documentos
                    </button>
                  </div>
                </div>
