  ...
  return (
    ...
    >
      <div className="relative">
        <div className="relative w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-linear-to-br from-indigo-600 to-purple-700 hover:from-indigo-700 hover:to-purple-800 shadow-xl hover:shadow-2xl flex items-center justify-center transition-all hover:scale-110 active:scale-95">
