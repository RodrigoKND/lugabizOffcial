        ...
        <>
          {isMobile ? (
            ...
            <motion.div
              ...
              className="absolute right-0 top-full mt-2 w-[22rem] bg-white rounded-2xl shadow-[0_8px_40px_rgba(0,0,0,0.08),0_2px_8px_rgba(0,0,0,0.04)] border border-stone-100 z-50 overflow-hidden"
            >
              {renderContent()}
            </motion.div>
          )}
